...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table ID="AdminPasswordTable" runat="server" CellSpacing="10">
        <asp:TableRow>
            ...
            </asp:TableCell><asp:TableHeaderCell ID="submitErrorMessage" runat="server" HorizontalAlign="Left" ForeColor="Red"></asp:TableHeaderCell></asp:TableRow></asp:Table><asp:Table ID="AddEmployeeTable" runat="server" CellSpacing="10" Visible="false">
        <asp:TableRow>
            ...
            </asp:TableCell><asp:TableHeaderCell ID="addEmployeeErrorMessage" runat="server" HorizontalAlign="Left" ForeColor="Red"></asp:TableHeaderCell></asp:TableRow></asp:Table><hr />
    <asp:Table ID="RemoveEmployeeTable" runat="server" CellSpacing="10" Visible="false">
        <asp:TableRow>
            ...
            </asp:TableCell><asp:TableHeaderCell ID="removeEmployeeMessage" runat="server" HorizontalAlign="Left" ForeColor="Red"></asp:TableHeaderCell></asp:TableRow></asp:Table><hr />
    <asp:Table ID="RemoveVisitTable" runat="server" CellSpacing="10" Visible="false">
        <asp:TableRow>
            ...
            </asp:TableCell><asp:TableHeaderCell ID="removeVisitMessage" runat="server" HorizontalAlign="Left" ForeColor="Red"></asp:TableHeaderCell></asp:TableRow></asp:Table><hr />
